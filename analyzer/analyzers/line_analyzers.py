...
from analyzer.analyzers.contants import (
    CLASS_DECLARATION_REGEX, COMMENT_SIGN, DEFAULT_CODE, DEFAULT_MSG,
    FUN_DECLARATION_REGEX, INDENTATION_CODE, INDENTATION_MSG,
    MAX_LINE_LENGTH, TODO_CODE, TODO_CODE_MSG,
    TOO_LONG_CODE, TOO_LONG_LINE_MSG,
    TOO_MANY_SPACES_CODE, TOO_MANY_SPACES_MSG_TEMPLATE,
